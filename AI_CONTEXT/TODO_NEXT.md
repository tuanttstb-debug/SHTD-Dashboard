...
- [x] **[P0] [TT] CẤP QUYỀN CALENDAR + redeploy New version** — XONG (2026-09-01): `authorizeCalendarScope()` + Authorize + redeploy.
- [x] **[P0] [TT] nghiệm thu LIVE** — XONG: **event đã lên Google Calendar** (smoke live PASS). Pha 1 hoàn tất trên production.
- [ ] **[TT] (tùy chọn) dùng thực tế** vài ngày: kiểm event định kỳ lặp đúng kỳ + Ngắt kết nối gỡ sạch + đổi deadline/tick xong → "Đồng bộ lại" (hoặc chờ trigger @7h30) cập nhật đúng.
