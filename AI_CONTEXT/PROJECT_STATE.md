...
| `assets/js/config.js` | 7 | ✅ S65: APP_VERSION = '6.33-concurrent-create-idlock-20260807'; S59: GS_WEBAPP_URL → deployment cơ quan `AKfycbw1…DSg` |
...
| Feature | Works? | Notes |
|---|---|---|
| **🔒 Guard tạo trùng đồng thời (5 entity)** | ✅ | S65: server reassign mã dưới `LockService` khi 2 người tạo cùng lúc → hết ghi đè. `Concurrency.gs` + `isNew`/`_adoptReassignedId`. 17/17 spec test. 🔴 cần GAS redeploy |
