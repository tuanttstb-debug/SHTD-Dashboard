# PROJECT STATE
**As of**: 2026-08-12 (Session 69 — Fix login hang/lock-out khi mạng chậm/bị chặn)
**Version**: v6.40 (`APP_VERSION = '6.40-login-hang-timeout-fix-20260812'`, `index.html ?v=20260812`)
**Remote HEAD (main)**: `72cbe6a` (S69 đã push)
